...
<div class="col-md-7">
<pre>Account Number			<input type="text" class="form-control" name="acc" id="acc" value="" onBlur="isNumeric()">

Card Number			<input type="text" class="form-control" name="card" value="" onBlur="b()">

Card Holder's Name		<input type="text"  class="form-control" name="crdname" id="crdname" value="" onBlur="d()">
</pre>
		
<span><b><?php echo "Amount to be deducted from your account is Rupees ".$tf; ?></b></span>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" class="btn btn-primary btn-lg" name="ok" value="Confirm" onClick="e()">
<input type="button" name="can" class="btn btn-primary btn-lg"  value="Cancel" onClick="g()">
</div>
</form><?php
}
else
